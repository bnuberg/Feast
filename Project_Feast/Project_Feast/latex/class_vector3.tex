...
Default constructor. Produces an empty \hyperlink{class_vector3}{Vector3}. Its values are set to 0. \hypertarget{class_vector3_ad53e22b52babdb90d423601f72467590}{}\index{Vector3@{Vector3}!Vector3@{Vector3}}
\index{Vector3@{Vector3}!Vector3@{Vector3}}
\subsubsection[{Vector3}]{\setlength{\rightskip}{0pt plus 5cm}Vector3\+::\+Vector3 (
\begin{DoxyParamCaption}
\item[{float}]{x, }
...
Input constructor. Creates a \hyperlink{class_vector3}{Vector3} based on input parameters. 
...
Copy constructor. Creates a new \hyperlink{class_vector3}{Vector3} based on an existing one. 
\begin{DoxyParams}{Parameters}
...
Cross product operation. Performs the cross product between 2 vectors. 
\begin{DoxyParams}{Parameters}
...
Dot product operation. Performs the dot product between two vectors. 
\begin{DoxyParams}{Parameters}
{\em v\+A} & The first vector. \\
\hline
...
Length operation. Finds the length of a vector. Does not use a \hyperlink{class_matth}{Matth}\+:\+: method. 
\begin{DoxyParams}{Parameters}
...
Square length operation. Finds the length squared of a vector. Does not use a square root. 
\begin{DoxyParams}{Parameters}
{\em v} & The input vector. \\
\hline
\end{DoxyParams}
...
Overloaded multiplication operator. Allows a \hyperlink{class_vector3}{Vector3} to be multiplied by a float. 
\begin{DoxyParams}{Parameters}
...
Overloaded $\ast$= operator. Allows a \hyperlink{class_vector3}{Vector3} to be multiplied by a float and have the result stored in the same vector. 
\begin{DoxyParams}{Parameters}
...
Overloaded addition operator. Allows 2 vectors to be added together. 
\begin{DoxyParams}{Parameters}
...
Overloaded += operator. Allows one vector to be added to another and the result is stored in the first. 
\begin{DoxyParams}{Parameters}
...
Overloaded subtraction operator. Allows one vector to be subtracted from another. 
\begin{DoxyParams}{Parameters}
...
Overloaded unary minus operator. Allows a vector to become negative by putting the minus sign in front of it. \begin{DoxyReturn}{Returns}
...
Overloaded -\/= operator. Allows one vector to be subtracted from another and the result is stored in the first. 
\begin{DoxyParams}{Parameters}
...
Overloaded division operator. Allows a vector to be divided by a float. 
\begin{DoxyParams}{Parameters}
